...
int dark4_interval = 500;  // how long to keep LED1 dark before beginning next flash
int dark5_interval = 750;  // how long to keep LED1 dark before beginning next flash
int dark6_interval = 200;  // how long to keep LED1 dark before beginning next flash
...
int led4 = 6;             // LED1 is attached to pin D6
int led5 = 5;            // LED2 is attached to pin D5
int led6 = 3;            // LED3 is attached to pin D3
...
int brightness4 = 0;      // how bright LED4 is at start
int brightness5 = 75;      // how bright LED5 is at start
int brightness6 = 40;    // how bright LED6 is at start
int dark1 = 0;            // start with LED1 on
int dark2 = 400;          // start with LED2 in dark period
int dark3 = 0;            // start with LED3 on
int dark4 = 0;            // start with LED4 on
int dark5 = 400;          // start with LED5 in dark period
int dark6 = 0;            // start with LED on
...
int fade4 = 1;    // give a starting place for fading LED4 
int fade5 = 1;    // give a starting place for fading LED5
int fade6 = 1;    // give a starting place for fading LED6
...
void loop()  { 
  ...
  brightness4 = brightness4 + fade4;
  brightness5 = brightness5 + fade5;
  brightness6 = brightness6 + fade6;
